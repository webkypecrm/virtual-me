            ...
            <div className="col-xl-4 col-md-6">
              <div className="blog">
                ...
                <div className="blog-item">
                  ...
                  <p className="text-truncate line-clamb-2">
                    Unlock limitless career opportunities by mastering Python,
                    one of the most versatile and in-demand ...
                  </p>
                  <div className="blog-info">
            ...
            <div className="col-xl-4 col-md-6">
              <div className="blog">
                ...
                <div className="blog-item">
                  ...
                  <p className="text-truncate line-clamb-2">
                    Discover how a Learning Management System (LMS) can
                    transform education and corporate training by ...
                  </p>
                  <div className="blog-info">
                    <div className="d-flex align-items-center flex-wrap justify-content-between gap-2">
                      <div className="d-flex align-items-center user-profile">
