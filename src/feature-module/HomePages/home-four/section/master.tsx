                ...
                <div className="row row-gap-4 align-items-center">
                  ...
                  >
                    <div className="join-mentor-img">
                      <ImageWithBasePath
                        src="https://dreamslms.dreamstechnologies.com/html/template/assets/img/feature/feature-18.jpg"
                        alt="Img"
                        className="img-fluid rounded-4"
                      />
                      <div className="joing-icon-award bg-warning">
                        <ImageWithBasePath
                          src="https://dreamslms.dreamstechnologies.com/html/template/assets/img/feature/feature-19.jpg"
                          alt="Img"
                          className="img-fluid"
                        />
                      </div>
              ...
              <div className="skills-wrap skill-center">
                <div className="row  row-gap-4 align-items-center">
                  ...
                  >
                    <div className="join-mentor-img">
                      <ImageWithBasePath
                        src="https://dreamslms.dreamstechnologies.com/html/template/assets/img/feature/feature-20.jpg"
                        alt="Img"
                        className="img-fluid rounded-4"
                      />
