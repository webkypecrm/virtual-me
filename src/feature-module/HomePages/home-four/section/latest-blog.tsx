                ...
                <div className="latest-blog-img">
                  <Link to={route.blogDetails}>
                    <ImageWithBasePath
                      className="img-fluid"
                      alt="Img"
                      src="https://dreamslms.dreamstechnologies.com/html/template/assets/img/blog/blog-31.jpg"
                    />
                  </Link>
                </div>
                ...
                <div className="latest-blog-img">
                  <Link to={route.blogDetails}>
                    <ImageWithBasePath
                      className="img-fluid"
                      alt="Img"
                      src="https://dreamslms.dreamstechnologies.com/html/template/assets/img/blog/blog-32.jpg"
                    />
                  </Link>
                </div>
                <div className="blog-content">
                ...
                <div className="latest-blog-img">
                  <Link to={route.blogDetails}>
                    <ImageWithBasePath
                      className="img-fluid"
                      alt="Img"
                      src="https://dreamslms.dreamstechnologies.com/html/template/assets/img/blog/blog-33.jpg"
                    />
                  </Link>
                </div>
                <div className="blog-content">
